    ...
    <div class="container-fluid">
      <div class="row my-2 sombra">
        ...
        <div class="col-sm-7 border">
          ...
          <p>    É importante questionar o quanto o desafiador cenário globalizado possibilita uma melhor visão global dos paradigmas corporativos.    É importante questionar o quanto o desafiador cenário globalizado possibilita uma melhor visão global dos paradigmas corporativos.    É importante questionar o quanto o desafiador cenário globalizado possibilita uma melhor visão global dos paradigmas corporativos.</p>
          <span>
      ...
      <div class="row my-2 sombra">
        ...
        <div class="col-sm-7 border">
          ...
          <p class="h4">Cor, altura, largura, comprimento</p>
          <p>sobre</p>
          <p>botao de contato para o produto, botao de editar, excluir</p>
        </div>
      </div>
      <div class="row my-2 sombra">
        <div class="col-sm-7 border">
          <p>Titulo</p>
          <p>Cor, altura, largura, comprimento</p>
          <p>sobre</p>
          <p>botao de contato para o produto, botao de editar, excluir</p>
        </div>
        <div class="col-sm-5 border">
